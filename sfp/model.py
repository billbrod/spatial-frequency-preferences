...
def load_model(save_path_stem):
    ...
    model = sfp.model.ConstantLogGaussianDonut(1,2,.4)
    model.load_state_dict(torch.load(save_path_stem + '_model.pt'))
    model.eval()
    model.to(device)    
